...
\STATE u ajuste son rayon de transmission au plus loin voisin LMST
	\IF {u $\in$ V reçoit <M,s> pour la premiere fois}
...
\subsection{ RNG Broadcast Oriented Protocol(RBOP) \cite{Cartigny2005}}
...
\hline
RRS \cite{Cartigny2003RNG} & \tickYes & \tickNo &  &  &  &  &  &  &  &  \\
\hline
LBOP \cite{Cartigny2005} & \tickYes & \tickNo &  &  &  &  &  &  &  &  \\
\hline
RBOP \cite{Cartigny2005} & \tickYes & \tickNo &  &  &  &  &  &  &  &  \\
\hline
TR-LBOP \cite{Ingelrest2004} & \tickYes & \tickNo &  &  &  &  &  &  &  &  \\
