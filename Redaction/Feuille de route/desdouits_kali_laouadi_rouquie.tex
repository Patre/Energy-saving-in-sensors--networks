...
{\bfseries Les tâches à effectuer pour ce TER sont les suivantes :}\\
\begin{itemize}\addtolength{\itemsep}{0.3cm}
	\item Mieux cerner la problématique (toute l'équipe).
	\item Faire l'état de l'art. Lire les articles suivants :
	\begin{itemize}
		\item Toute l'équipe : \emph{\bibentry{Champ2009DLBIP}}
		\item Toute l'équipe : \emph{\bibentry{Champ2009lifetime}}
		\item Toute l'équipe : \emph{\bibentry{WSNET}}
		\item Chloé Desdouits : \emph{\bibentry{Chang2000}}
		\item Zahir Kali : \emph{\bibentry{Akyildiz2002}}
		\item Rabah Laouadi : \emph{\bibentry{Dong2005}}
		\item Samuel Rouquie : \emph{\bibentry{Rodoplu1998}}
	\end{itemize}
	\item Faire la synthèse des connaissances acquises (Samuel Rouquie).
	\item Réfléchir à de nouvelles solutions (toute l'équipe).
	\item Programmation / simulation WSNET (Chloé Desdouits, Rabah Laouadi, Zahir Kali).
	\item Analyse des résultats de simulation (toute l'équipe).
\end{itemize}
