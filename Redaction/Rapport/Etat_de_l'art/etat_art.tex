...
\begin{mydef}
 ...
 De façon intuitive, pour construire le graphe RNG, il suffit de connecter chaque sommet à ses voisins les plus proches.\\
...
\emph{Mots clés :} broadcast, local, avec balisage, graphe de voisinage, RNG, rayon d'émission variable, déterministe.
...
\emph{Description :} TRLBOP est une amélioration de LBOP. Le principe de choisir les noeuds relais pour qu'ils se rapproche le plus possible d'un maillage hexagonale de rayon optimal théorique $R_{opt}=\sqrt[\alpha]{\frac{2c}{\alpha-2}}$.
...
ABBA & \tickYes & \tickNo & \tickNo & \tickYes & \tickYes & \tickNo & \tickNo & \tickYes & \tickYes & \tickNo \\
