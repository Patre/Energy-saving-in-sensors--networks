...
\begin{figure}[H]
\centering
\includegraphics[angle=90 , scale=0.3]{Etat_de_l'art/source/GrapheUnit.pdf}
...
angle interne par le nombre de côtés n, elle sera égale à $\pi m-2 \pi$  radian. Un angle interne vaut donc $\frac{(m-2)\pi }{m}$ . Nous avons: 
