...
Cependant, un tel modèle est extrèmement complexe à étudier. C'est pourquoi nous nous ramènerons à un modèle plus simple mais moins réaliste choisi dans la beaucoup d'articles  \cite{Cartigny2003LMEB,Ingelrest2004}.
Notre modélisation de base des réseaux de capteurs sans fil \textbf{$M_2$} est la suivante :
