...
struct source_adv_p {
    int type;   // packet type SOURCE_ADV_TYPE
...
struct sensor_adv_p {
    int type;        // packet type SENSOR_ADV_TYPE
...
struct source_data_p {
    int type;      // packet type SOURCE_DATA_TYPE
...
struct sink_adv_p {
    int type;     // packet type SINK_ADV_TYPE
...
struct home_adv_p {
    int type;        // packet type HOME_ADV_TYPE
